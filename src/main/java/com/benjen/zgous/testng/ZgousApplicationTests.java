...
@SpringBootTest
@Slf4j
class ZgousApplicationTests extends AbstractTestNGSpringContextTests implements ITest {
...
//						System.out.println(replaceValue);
	...
	public void BeforeMethod(Method method, Object[] testData){
		//获取后半段自定义测试用例名称
		JSONObject laterTestName = (JSONObject) JSONObject.toJSON(testData[0]);
		testName.set(method.getName() + "_" + laterTestName.get("id"));
	}
